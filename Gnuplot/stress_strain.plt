...
clear
reset
pl '1e9_XY_Shear_1K' u ($1-100000)*0.001*0.001:(-$2) tit "Zigzag"   w l lw 8 lc rgb "#d00000" 
...
repl '1e9_YX_Shear_1K' u ($1-100000)*0.001*0.001:(-$2) tit "Armchair"  w l  lw 8 lc rgb "#0000d0" 
